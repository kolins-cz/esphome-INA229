...
from esphome.const import (
    # following copied from ina219 lib
    CONF_BUS_VOLTAGE,
    CONF_CURRENT,
    CONF_ID,
    CONF_MAX_CURRENT,
...
ina229_ns = cg.esphome_ns.namespace('ina229')
INA229Component = ina229_ns.class_('INA229Component', cg.PollingComponent, spi.SPIDevice)



""" 
#example for generic SPI sensor looked like this
...
def to_code(config):
    """
    #this was in original example for SPI sensor. yield vs. await
